    ...
    <section className="relative min-h-[80vh] overflow-hidden bg-transparent px-6 py-16 md:px-16 lg:px-24">
      <div className="relative mx-auto max-w-6xl space-y-10">
        ...
        <div className="max-w-sm mx-auto">
          <div className="bg-white dark:bg-stone-900 rounded-[2.5rem] p-2 text-center shadow-sm border border-stone-200 dark:border-stone-800 hover:shadow-md transition duration-300">
            <a
              href="mailto:arrya.a.dev@gmail.com"
              className="flex items-center justify-center gap-3 text-emerald-700 dark:text-emerald-400 hover:text-emerald-600 dark:hover:text-emerald-300 transition duration-300"
            >
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="text-center pt-2">
                <button
                  type="submit"
                  className="inline-flex items-center gap-2 px-8 py-3.5 rounded-full bg-emerald-600 dark:bg-emerald-600 text-white font-semibold text-sm shadow-lg shadow-emerald-600/20 hover:bg-emerald-700 dark:hover:bg-emerald-500 hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5 cursor-pointer"
                >
